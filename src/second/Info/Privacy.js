...
const Privacy = () => {
  return (
    <>
      <h1>プライバシーポリシー</h1>
      <p>
        onlytext（以下「当サイト」）は、利用者の皆様から取得した個人情報の保護に万全を尽くし、法令およびその他の規範を遵守いたします。そして、個人情報の取り扱いについて以下の通り実施いたします。
      </p>
      <h2>個人情報の利用範囲について</h2>
      <h3>
        利用者の皆様から取得した個人情報は以下の目的のために利用させていただきます。
      </h3>
      <p>本サービスの利用に必要な会員の管理のためのシステム運営</p>
      <p>本サービスの利便性を向上させるためのシステム運営</p>
      <p>
        メンテナンス情報や、重要なご連絡など、本サービスを運用する上で必要な皆様へのお知らせ
      </p>
      <p>本サービスへのご質問、お問い合わせなどに関する回答</p>
      <p>
      ...
      <p>当サイトの他サービスへの情報の連携・情報の共有</p>
      <p>本サービスの新規開発に必要なデータの解析や分析</p>
      <p>
